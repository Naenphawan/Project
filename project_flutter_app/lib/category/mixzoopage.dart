...
class Mixzoopage extends StatefulWidget {
  Mixzoopage({Key? key}) : super(key: key);

  @override
  State<Mixzoopage> createState() => _MixzoopageState();
}

class _MixzoopageState extends State<Mixzoopage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("สัตว์อื่นๆ", style: TextStyle(fontWeight: FontWeight.bold)),
